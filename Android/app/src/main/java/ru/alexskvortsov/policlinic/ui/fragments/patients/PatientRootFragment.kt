...
import kotlinx.android.synthetic.main.patient_root_fragment.*
...
class PatientRootFragment : BaseMviFlowFragment<LogOutView, LogOutPresenter>(), LogOutView {

    override val layoutRes: Int
        get() = R.layout.patient_root_fragment

    override val navHostId: Int
        get() = R.id.patientNavHostFragment
    ...
    override fun onResume() {
        super.onResume()
        patient_bottom_navigation.setupLongText()
        patient_bottom_navigation.setupWithNavControllerReselectionDisabled(navController)
    }
